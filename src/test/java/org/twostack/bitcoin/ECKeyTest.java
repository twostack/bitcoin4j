...
import org.twostack.bitcoin.crypto.EncryptedData;
...
import org.twostack.bitcoin.transaction.SigHash;
import org.twostack.bitcoin.transaction.SigHashType;
...
public class ECKeyTest {
    ...
    private static final NetworkAddressType ADDRESS_TESTNET = NetworkAddressType.MAIN_PKH;
    private static final NetworkAddressType ADDRESS_MAINNET = NetworkAddressType.MAIN_PKH;
    ...
    public void sValue() throws Exception {
        ...
        final ECKey.ECDSASignature first = sigs.get(0);
    ...
    public void base58Encoding() throws Exception {
        ...
        assertEquals(addr, LegacyAddress.fromKey(NetworkAddressType.TEST_PKH, PublicKey.fromBytes(key.getPubKey())).toBase58());
    }
    ...
    public void signTextMessage() throws Exception {
        ...
        log.info("Message signed with " + LegacyAddress.fromKey(NetworkAddressType.MAIN_PKH, PublicKey.fromBytes(key.getPubKey())) + ": " + signatureBase64);
...
//    }
    ...
    public void testCreatedSigAndPubkeyAreCanonical() throws Exception {
        ...
        encodedSig[sigBytes.length] = SigHashType.ALL.byteValue();
