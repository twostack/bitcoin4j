...
public class DumpedPrivateKeyTest {
    ...
    public void fromBase58_tooShort() {
        String base58 = Base58.encodeChecked(NetworkParameters.getDumpedPrivateKeyHeader(MAINNET), new byte[31]);
        DumpedPrivateKey.fromBase58(null, base58);
    }

    @Test(expected = AddressFormatException.InvalidDataLength.class)
    public void fromBase58_tooLong() {
        String base58 = Base58.encodeChecked(NetworkParameters.getDumpedPrivateKeyHeader(MAINNET), new byte[34]);
        DumpedPrivateKey.fromBase58(null, base58);
    }
