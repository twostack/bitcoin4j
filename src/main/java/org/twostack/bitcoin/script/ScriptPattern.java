...
import static org.twostack.bitcoin.script.Script.decodeFromOpN;
...
public class ScriptPattern {
     ...
     */
    public static boolean isP2PKH(org.twostack.bitcoin.script.Script script) {
        List<org.twostack.bitcoin.script.ScriptChunk> chunks = script.chunks;
        if (chunks.size() != 5)
            return false;
     ...
     */
    public static boolean isP2PK(org.twostack.bitcoin.script.Script script) {
        List<org.twostack.bitcoin.script.ScriptChunk> chunks = script.chunks;
        if (chunks.size() != 2)
            return false;
        org.twostack.bitcoin.script.ScriptChunk chunk0 = chunks.get(0);
        if (chunk0.isOpCode())
            return false;
